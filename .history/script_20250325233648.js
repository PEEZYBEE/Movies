document.addEventListener("DOMContentLoaded", () => {
    fetch("/series") // Fetch series data from the JSON server
        .then(response => {
            if (!response.ok) {
        ...
        .then(seriesData => {
            ...
            seriesData.forEach(series => {
                ...
                downloadButton.textContent = "Download";                 downloadButton.style.marginTop = "20px";                 downloadButton.style.marginBottom = "20px";                 downloadButton.style.padding = "5px";                 downloadButton.style.backgroundColor = "#D4AF37";                 downloadButton.style.width = "10%";
